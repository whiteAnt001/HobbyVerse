...
<body>
					...
					<div class="dropdown">
						...
						<ul class="dropdown-menu option-dropdown-menu"
							...
							<li><a class="dropdown-item option-dropdown-item"
								href="/category/meet?option=korean">가나다 순</a></li>
							<li><a class="dropdown-item option-dropdown-item"
								href="/category/meet?option=popular">인기 순</a></li>
							<li><a class="dropdown-item option-dropdown-item"
								href="/category/meet?option=recent">최근 순</a></li>
						</ul>
					</div>
				</div>
				<div class="row">
	...
	<div align="center">
		...
		<c:if test="${startPage > 1}">
			<a
				href="/category/meet?pageNo=${startPage - 1}&option=${param.option}">[이전]</a>
		</c:if>
		...
		<c:forEach begin="${startPage }" end="${endPage}" var="i">
			...
			<a href="/category/meet?pageNo=${i}&option=${param.option}">${i}</a>
			<c:if test="${currentPage == i}">
				</font>
			</c:if>
		</c:forEach>
		...
		<c:if test="${endPage < pageCount}">
			<a href="/category/meet?pageNo=${endPage + 1}&option=${param.option}">[다음]</a>
		</c:if>
	</div>
</body>
</html>